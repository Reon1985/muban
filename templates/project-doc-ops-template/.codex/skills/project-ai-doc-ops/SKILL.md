...
description: "Project-repository adapter for the global ai-doc-ops-core workflow. Use after or together with ai-doc-ops-core when working in this repository to supply the actual startup docs, task routing, current-version entry points, preview-first baseline, and repository-specific execution expectations."
---
...
Use this skill as the project adapter layer for the global `ai-doc-ops-core` skill.
...
1. which repository docs to read first
